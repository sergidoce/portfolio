    ...
    return (
        ...
        <div className = 'bg-color-secundario py-20'>
          <div className = 'container mx-auto h-full flex justify-center font-Catamaran'>
              <div className = ''>
                  <h1 className='text-color-primario text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl '>CONTACT</h1>
                  <div className = 'mt-10 text-color-primario'>
                     <form action="" onSubmit={this.sendEmail}>
                        <div className = 'flex'>
                            <div className = ' flex'>
                                <div>
                                    <label className = 'block tracking-wide text-2xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl mb-2' htmlFor="">Name</label>
                            ...
                            <div className = 'flex ml-5'>
                                <div>
                                    <label className = 'block tracking-wide text-2xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl mb-2' htmlFor="">Surname</label>
                        ...
                        <div className = 'mt-10'>
                            <label className = 'block tracking-wide text-2xl sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl mb-2' htmlFor="">Message</label>
                        ...
                        <div className = 'mt-10'>
                            {this.state.alert_message == 'success' ? <h3 className = 'text-xl text-green-700'>Message sent correctly</h3> : null}
							{this.state.alert_message == 'error' ? <h3 className = 'text-xl text-red-700'>You must fill all the fields before sending the message</h3> : null}    
